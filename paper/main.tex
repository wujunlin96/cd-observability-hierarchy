...
\title{Observability of Hidden-Sector Limiting Speed Scales: No-Go Results and Interface Phenomenology}
\author{Junlin Wu\\
...
\noindent\textbf{Keywords:} hidden sectors; limiting speeds; Lorentz symmetry; observability; interface phenomenology; Standard-Model Extension
...
\subsection{Scope: Spin and Internal Degrees}
...
The public repository, \path{https://github.com/wujunlin96/cd-observability-hierarchy}, contains the delta-interface, finite-wall, and plotting scripts. In the recorded finite-wall scan, the maximum flux-conservation error is below \(5\times10^{-14}\).
...
\subsection*{Ethics, Funding, and Conflicts of Interest}
...
\subsection*{Author Contributions and AI Assistance}
