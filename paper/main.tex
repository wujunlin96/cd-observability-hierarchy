...
The submission bibliography should use \path{references/observability_used_references.bib}, which contains only the 27 references cited in the present manuscript. In the public release this bibliography is also mirrored as \path{paper/references.bib}.
