...
\path{notes/novelty_external_audit_v107.md} & novelty and literature-boundary audit & novelty decision \\
\path{notes/paper_self_review_v108.md} & adversarial self-review & revision risks and fixes \\
\path{notes/current_research_decision_v109.md} & current research decision & theorem-paper route \\
\bottomrule
\end{tabularx}
\end{center}
...
This manuscript uses analytic derivations and generated toy-model data. The scripts and generated artifacts are listed in Appendix D. The public artifact repository is \path{https://github.com/wujunlin96/cd-observability-hierarchy}; a persistent archive can be minted for a later journal version if needed.
